...
the MeshData property of a PartOperation/UnionOperation instance.
"""
...
def _compute_tangent(
    ...
    """Compute a tangent vector for a triangle (Lengyel's method)."""
